...
//    cout << new_tree.toString() << endl;
    ...
    << "mean elapsed time per regraft: " << elapsed_seconds.count()/((double) num_of_iterations) << " sec.\n"
    << "Regrafts pr. second: " << ((double) num_of_iterations)/((double)elapsed_seconds.count()) << " rps" << endl;
}
